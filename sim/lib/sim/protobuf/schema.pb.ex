defmodule Sim.Protobuf.EasingMode do
  @moduledoc false
...
defmodule Sim.Protobuf.Packet do
  ...
  field :config, 1, type: Sim.Protobuf.Config, oneof: 0
  field :frame, 2, type: Sim.Protobuf.Frame, oneof: 0
end

defmodule Sim.Protobuf.Config do
  @moduledoc false
...
defmodule Sim.Protobuf.ResponsePacket do
  ...
  field :client_info, 1, type: Sim.Protobuf.ClientInfo, json_name: "clientInfo", oneof: 0
  field :remote_log, 2, type: Sim.Protobuf.RemoteLog, json_name: "remoteLog", oneof: 0
end

defmodule Sim.Protobuf.ClientInfo do
  @moduledoc false
